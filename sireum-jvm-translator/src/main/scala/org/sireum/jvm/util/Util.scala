...
object Util {
  ...
  val insnTypeMap = Map(Opcodes.ICONST_0 -> "int", Opcodes.ICONST_1 -> "int", Opcodes.ICONST_2 -> "int", 
      ...
      Opcodes.DCONST_0 -> "double", Opcodes.DCONST_1 -> "double", Opcodes.ACONST_NULL -> "object", 
      
      Opcodes.IALOAD -> "int[]", Opcodes.LALOAD -> "long[]", Opcodes.FALOAD -> "float[]", 
      Opcodes.DALOAD -> "double[]", Opcodes.AALOAD -> "object[]", Opcodes.BALOAD -> "boolean[]",
      ...
      Opcodes.AASTORE -> "object[]", Opcodes.BASTORE -> "boolean[]", Opcodes.CASTORE -> "char[]",
  ...
  val varTypeMap = Map(Opcodes.ILOAD -> "int", Opcodes.LLOAD -> "long", Opcodes.FLOAD -> "float",
      Opcodes.DLOAD -> "double", Opcodes.ALOAD -> "object")
  ...
  def getPilarMethod(name:String) = {
    "{|"+name.replace("/",".")+"|}"
  }
  
  def getPilarStaticField(name:String) = {
    "+|"+name.replace("/",".")+"|+"
  }
  
  def getPilarField(name: String) ={
    "<|"+name.replace("/",".")+"|>"
  }
